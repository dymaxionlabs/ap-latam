...
def train(trainable_layers):
	train_files = glob.glob(os.path.join('data_keras/','train_hires_balanced/**/', '*.jpg'))
	validation_files = glob.glob(os.path.join('data_keras/', 'validation_hires_balanced/**/', '*.jpg'))
